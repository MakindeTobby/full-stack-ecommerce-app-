        ...
        return (
            ...
            <Link
                ...
                className={classNames(
                    "flex h-9 w-9 items-center justify-center rounded-lg border transition border-slate-200 bg-white text-slate-500 hover:bg-slate-50",
                    //   isDark ? "border-[#1F2937] bg-[#111827] text-slate-400 hover:bg-[#1F2937] hover:text-white" : ""
                )}
                aria-label="Account"
            >
        ...
        <div className="relative" ref={menuRef}>
            ...
            >
                {avatar ? (
                    ...
                    <div className="flex h-7 w-7 items-center justify-center rounded-full bg-black/90 text-xs font-semibold text-white">
            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className="absolute right-0 z-50 mt-2 w-60 rounded-xl border border-black/10 bg-white shadow-lg"
                    >
