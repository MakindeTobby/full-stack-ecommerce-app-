...
const SearchBar = ({
    ...
    return (
        <div ref={wrapperRef} className="hidden lg:flex flex-1 max-w-sm ml-2 relative">
            <form
                onSubmit={onSubmit}
                className="flex w-full items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3.5 py-2 transition focus-within:border-violet-500 focus-within:ring-2 focus-within:ring-violet-500/20 focus-within:bg-white"
            ...
            >
                ...
                <input
                    ...
                    className={classNames(
                        "w-full bg-transparent! text-slate-100 dark:placeholder:text-slate-500 dark:text-slate-800 placeholder:text-slate-400 text-sm outline-none",
            ...
            {showDropdown && (
                <div className="absolute left-0 top-10 right-0 z-50 mt-2 overflow-hidden rounded-2xl border border-black/10 bg-white shadow-xl">
                    {surfaceRecent ? (
                        <div className="p-3">
                            <div className="mb-2 flex items-center justify-between text-xs font-semibold capitalize tracking-wide text-gray-500">
                    ...
                    {trimmed.length > 0 && (
                        <div className="border-t border-black/5 p-3">
                            <div className="mb-2 text-xs font-semibold capitalize tracking-wide text-gray-500">
                                Suggestions
                            </div>
                            {loading && (
